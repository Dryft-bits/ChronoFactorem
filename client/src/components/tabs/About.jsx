      ...
      <div style={{ display:'flex', justifyContent:'center' }}>
        <Card className={classes.root}>
          ...
          <ThemeProvider theme={theme}>
            <CardActions>
              <Button variant="contained" size="large" color="primary" startIcon={<GitHubIcon/>} style={{marginLeft:"0.5vw",marginBottom:"1.5vh"}} href="https://github.com/crux-bphc/ChronoFactorem" target="_blank">Learn More</Button>
            </CardActions>
          </ThemeProvider>
        </Card>
      </div>
